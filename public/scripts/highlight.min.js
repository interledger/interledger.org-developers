  ...
  class a {
    ...
    static _walk(e, t) {
      return (
        'string' == typeof t
          ? e.addText(t)
          : t.children && (e.openNode(t), t.children.forEach((t) => a._walk(e, t)), e.closeNode(t)),
        e
      )
    }
    static _collapse(e) {
      ...
      function E(e, n, s, o) {
        ...
        function l() {
          ...
          for (; t; ) {
            ...
            ;(e = S.keywordPatternRe.lastIndex), (t = S.keywordPatternRe.exec(R))
          }
          var i
        ...
        function y(i, o) {
          ...
          if ('illegal' === o.type && !s) {
            const e = Error(
              'Illegal lexeme "' + a + '" for mode "' + (S.scope || '<unnamed>') + '"'
            )
            throw ((e.mode = S), e)
          }
          if ('end' === o.type) {
        ...
        try {
          ...
          return (
            M.finalize(),
            (N = M.toHTML()),
            { language: e, value: N, relevance: j, illegal: !1, _emitter: M, _top: S }
          )
        } catch (t) {
...
'object' == typeof exports &&
  ...
  (module.exports = hljs) /*! `abnf` grammar compiled for Highlight.js 11.8.0 */
;(() => {
  var e = (() => {
    return (e) => {
      const a = e.regex,
      ...
      return {
        ...
        contains: [
          ...
          { scope: 'attribute', match: a.concat(/^[a-zA-Z][a-zA-Z0-9-]*/, /(?=\s*=)/) },
          s,
