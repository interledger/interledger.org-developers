...
Essentially, it's the "brain" that knows how to speak "chip card" securely and according to global standards.
...
2. References the card's wallet address (Customer ASE)
...
- Further development of the Rafiki SDK to support the new POS/Card services
- New Merchant-API service to support ASE's with regards to:
  - Merchant onboarding
