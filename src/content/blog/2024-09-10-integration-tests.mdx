...
![Integration Test Architecture Diagram](/developers/img/blog/2024-09-10/architecture.png)
...
This is our primary payment flow and would be used in contexts such as e-commerce. It consist of creating an incoming payment, quote, and outgoing payment along with their requisite grants. The outgoing payment requires a grant interaction which needs to be implemented by an ASE and is mocked for these tests. Refer to our documentation for details on the [grant interaction flow](https://rafiki.dev/concepts/open-payments/grant-interaction/) and [this blog post](https://interledger.org/developers/blog/open-payments-cinderella-story/) for an in-depth look into our authorization method.
...
<LargeImg
  src="/developers/img/blog/2024-09-10/url-problem.png"
