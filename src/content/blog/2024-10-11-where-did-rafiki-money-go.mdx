...
<video src="/developers/img/blog/2024-10-11/hover-effect.mp4" controls autoplay loop></video>
...
We truly hope you enjoy this new design as much as we do! We look forward to your [feedback and opinion](https://github.com/interledger/testnet/discussions/landing)! Don’t be shy!

We put our heart and soul into making it both fun and user-friendly. So continue exploring wallet.interledger-test.dev and boutique.interledger-test.dev, and remember, we value and welcome all your feedback! Reach out to us either on [Slack community channels](https://communityinviter.com/apps/interledger/interledger-working-groups-slack), or open a discussion on [Github Test Wallet](https://github.com/interledger/testnet/discussions/landing).
