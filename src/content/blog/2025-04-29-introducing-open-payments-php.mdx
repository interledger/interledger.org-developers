...
✅ Full support for [Grants](https://openpayments.dev/introduction/grants/), [Incoming Payments](https://openpayments.dev/introduction/op-flow/#incoming-payment), [Outgoing Payments](https://openpayments.dev/introduction/op-flow/#outgoing-paymenthttps://openpayments.dev/introduction/op-flow/#outgoing-payment), [Quotes](https://openpayments.dev/introduction/op-flow/#quote), and [Token](https://openpayments.dev/snippets/token-rotate/) management.
...
With just a few lines of code, PHP developers can now create grants, request quotes, initiate outgoing payments, or complete incoming payments with http signature headers — all fully compliant with Open Payments specifications.
...
[Interledger Foundation](http://interledger.org/)
