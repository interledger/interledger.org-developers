...
As of v1.1.2-beta, enabling **Smart Redirect**, Rafiki detects when a request is coming from a browser (Accept: text/html). Instead of showing raw JSON, the request automatically redirects to a user-friendly payment page defined in your environment settings.
