---
title: "Balancing the Ledger: Rafiki TigerBeetle Integration"
...
![Balancing the Ledger](/developers/img/blog/2024-12-17/balancing.png)
...
Rafiki documentation has more [accounting examples](https://rafiki.dev/overview/concepts/accounting).
