...
authors: [Sid Vishnoi]
author_urls: [https://sidvishnoi.com]
tags:
  - Web Monetization
---
...
![Web Monetization extension's popup](/developers/img/blog/2024-12-05/extension-popup.png)
...
Want to dive deeper into our testing strategy? Check out our [GitHub repo for the Web Monetization extension](https://github.com/interledger/web-monetization-extension). We're always open to feedback and contributions, so feel free to submit a pull request, join our [community slack](https://communityinviter.com/apps/interledger/interledger-working-groups-slack), or participate in the next [community call](https://docs.google.com/document/u/1/d/1T_Q_eRZtL8GluJR9rVADd7fvkB8mPluMk-d96LM4vlg/edit#heading=h.ybdhwl6k5886).!
