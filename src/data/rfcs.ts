...
export const PUBLISHED_RFCS = [
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0027-interledger-protocol-4/0027-interledger-protocol-4.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0001-interledger-architecture/0001-interledger-architecture.md'
  },
  {
    id: 'ilp-addresses',
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0015-ilp-addresses/0015-ilp-addresses.md'
  },
  {
    id: 'stream-protocol',
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0029-stream/0029-stream.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0009-simple-payment-setup-protocol/0009-simple-payment-setup-protocol.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0032-peering-clearing-settlement/0032-peering-clearing-settlement.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0038-settlement-engines/0038-settlement-engines.md'
  },
  {
    id: 'ilp-over-http',
    title: 'ILP Over HTTP',
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0035-ilp-over-http/0035-ilp-over-http.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0023-bilateral-transfer-protocol/0023-bilateral-transfer-protocol.md'
  },
  {
    ...
    sourceRawUrl:
      'https://raw.githubusercontent.com/interledger/rfcs/s2-general-cleanup/0022-hashed-timelock-agreements/0022-hashed-timelock-agreements.md'
  }
