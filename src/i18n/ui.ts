...
export const ui: LanguageUi = {
  en: {
    ...
    "nav.tech-blog-description": "Hear stories and experiences from the team who is working on making Interledger, the interoperable global payments network, a reality.",
    "nav.podcast": "Podcast",
    "nav.art": "Art",
  ...
  es: {
    ...
    "nav.tech-blog-description": "Escucha historias y experiencias del equipo que está trabajando en hacer de Interledger, la red de pagos interoperable global, una realidad.",
    "nav.podcast": "Podcast",
    "nav.art": "Arte",
    "nav.community-forem": "Community Forem",
